...
const BasicTable = ({
  ...
  useEffect(() => {
    ...
    } else if (selection === "Correspondencia") {
      dispatch(
        visitantesActions.getCorrespondenciaInit({
          dataInit,
          visitantesRowsCallback,
        })
      );
    }
  }, [dataInit, dispatch, selection]);
          ...
          {(rowsPerPage > 0
            ...
            <TableRow key={index}>
              ...
              >
                ...
                {selection === "Correspondencia" && (
                  <p>
                    Fecha entrega: {row.fecha_recibido} <br />
                    Fecha Salida: {row.fecha_entrega}
                  </p>
                )}
              </TableCell>
              <TableCell
              ...
              >
                ...
                {selection === "Correspondencia" && (
                  <p>
                    Transportador: {row.transportador} <br />
                    Numero guia: {row.numero_guia}
                  </p>
                )}
              </TableCell>
            </TableRow>
